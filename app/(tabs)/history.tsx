      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {surveys.length === 0 ? (
          <BlurView intensity={50} tint={tint} style={[styles.emptyCard, { backgroundColor: card, borderColor: cardBorder }]}>
            ...
            <Text style={[styles.emptyText, { color: subtext }]}>No survey history yet.</Text>
          </BlurView>
        ) : (
...
const styles = StyleSheet.create({
  ...
  actionButton: { flex: 1, minWidth: 100, paddingVertical: 12, borderRadius: 14, borderWidth: 1, alignItems: 'center' },
  ...
  emptyCard: { borderRadius: 20, padding: 28, alignItems: 'center', justifyContent: 'center', borderWidth: 1, overflow: 'hidden' },
